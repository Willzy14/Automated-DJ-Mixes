...
class TrackAnalysis:
    ...
    # Rekordbox phrase map (None = librosa-only analysis)
    rekordbox_phrases: list | None = None      # list[PhraseEntry] — full structural map
    analysis_source: str = "librosa"           # "librosa" or "rekordbox"
