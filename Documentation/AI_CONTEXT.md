...
### 2026-09-13 (Latest Session) - three by-ear bugs fixed, the swap-first redesign's item (a) built + Codex-reviewed + merged, first burn list created (Fable + Astra cross-eval)
...
> **TOP (2026-09-13): `Documentation/BURN_LIST.md` is now the live, maintained answer to "what's
