...
Scaffolding only — module files created with no functional code. Awaiting:
1. Sam to create a minimal Ableton Live 12 template and commit it to `Templates/`
2. First module implementation (analysis.py + sequencer.py)
